...
// #include "yei_threespace_api4.h" //this should be replaced with v5 as below
...
// #include "readerthreadWithYaw.h" //this should be replaced with shared version as below
